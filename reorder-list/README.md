<h2>143. Reorder List</h2><h3>Medium</h3><hr><div style="user-select: auto;"><p style="user-select: auto;">You are given the head of a singly linked-list. The list can be represented as:</p>
