...
const homePage = (problems) => {
  ...
  const footer = `<footer><p>Built with ❤️ love and 💦 sweat one ✅ AC at a time.</p><nav aria-label="Profile links" class="social-links"><a class="social-icon leetcode" href="https://leetcode.com/Suvraneel/" aria-label="LeetCode profile"></a><a class="social-icon github" href="https://github.com/Suvraneel" aria-label="GitHub repository"></a><a class="social-icon linkedin" href="https://www.linkedin.com/in/suvraneel" aria-label="LinkedIn profile"></a></nav><a class="star-link" href="https://github.com/Suvraneel/LeetCode">☆ Star this repository if it helps</a><small>© 2026 Suvraneel</small></footer>`;
