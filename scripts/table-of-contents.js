...
const homePageBase = (problems) => {
  ...
  const data = problems.map((p) => {
    ...
    return { n:p.number, t:p.title, d:p.difficulty, l:solutions.map((s) => s.language), s:solutions, notes:Boolean(notesFromDirectory(p.directory)), added:p.firstCommittedAt, lc:`https://leetcode.com/problems/${p.slug}/`, u:`${page}#problem-statement`, notesUrl:`${page}#notes` };
  });
...
const homePage = (problems) => {
  ...
  const footer = `<footer><p>Built with ❤️ love and 💦 sweat one ✅ AC at a time.</p><nav aria-label="Profile links" class="social-links"><a class="social-icon leetcode" href="https://leetcode.com/Suvraneel/" aria-label="LeetCode profile"></a><a class="social-icon github" href="https://github.com/Suvraneel/LeetCode" aria-label="GitHub repository"></a><a class="social-icon linkedin" href="https://www.linkedin.com/in/suvraneel" aria-label="LinkedIn profile"></a></nav><a class="star-link" href="https://github.com/Suvraneel/LeetCode">☆ Star this repository if it helps</a><small>© 2026 Suvraneel</small></footer>`;
  ...
  return homePageBase(problems)
    ...
    .replace('<span class="number">#\'+p.n+\'</span>', '<a class="number" href="\'+p.lc+\'">#\'+p.n+\'</a>')
    .replace('<span class="badge \'+p.d.toLowerCase()+\'">\'+p.d+\'</span>', '<a class="badge \'+p.d.toLowerCase()+\'" href="\'+p.lc+\'">\'+p.d+\'</a>')
    ...
    .replace('</style>', 'h1{font:700 clamp(2rem,5vw,5.25rem)/1 ui-sans-serif,system-ui,sans-serif;letter-spacing:-.035em;white-space:nowrap}.profile-badge{display:inline-flex!important;align-items:center;gap:.5rem}.profile-handle{display:inline;color:var(--link);font:600 .88rem ui-monospace,SFMono-Regular,monospace;letter-spacing:-.02em}.donut{width:74px;height:74px;border-radius:50%;display:grid;place-items:center;flex:0 0 auto}.donut span{display:grid;place-items:center;width:52px;height:52px;border-radius:50%;background:var(--bg);color:var(--muted);font-size:.65rem;text-align:center}.donut b{display:block;color:var(--text);font-size:1rem}.chart-copy h2{font-size:1rem;margin:0}.chart-copy p{margin:.25rem 0 0;font-size:.9rem}footer{border-top:1px solid var(--line);margin-top:3rem;padding-top:1.25rem;color:var(--muted);font-size:.9rem}footer p{margin:0 0 .55rem}.social-links{display:flex;gap:.8rem;margin-bottom:.65rem}.social-icon{display:grid;place-items:center;width:2rem;height:2rem;border:1px solid var(--line);border-radius:7px;background:var(--text);transition:border-color .18s,transform .18s}.social-icon:hover{border-color:var(--link);transform:translateY(-1px)}.social-icon:before{content:"";width:1rem;height:1rem;background:var(--bg);mask:center/contain no-repeat;-webkit-mask:center/contain no-repeat}.social-icon.leetcode:before{mask-image:url(https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/leetcode.svg);-webkit-mask-image:url(https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/leetcode.svg)}.social-icon.github:before{mask-image:url(https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/github.svg);-webkit-mask-image:url(https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/github.svg)}.social-icon.linkedin:before{mask-image:url(https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/linkedin.svg);-webkit-mask-image:url(https://cdn.jsdelivr.net/npm/simple-icons@latest/icons/linkedin.svg)}footer a{color:var(--link);text-decoration:none}.star-link{display:block;margin-bottom:.55rem}footer small{font-size:.8rem}@media(max-width:650px){h1{font-size:clamp(1.65rem,8vw,2.75rem)}.donut{width:62px;height:62px}.donut span{width:43px;height:43px;font-size:.58rem}}</style>');
};
